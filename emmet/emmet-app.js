...
define('filter/main',['require','exports','module','lodash','../utils/common','../assets/profile','../assets/resources','./html','./haml','./xsl','./bem','./comment','./escape','./singleLine','./trim'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
