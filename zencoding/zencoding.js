...
zen_coding.require('actions').add('select_line', function(editor) {
	...
	"html": {
		...
		"abbreviations": {
			...
			"link:css": "<link rel=\"stylesheet\" href=\"${0:style}.css\" media=\"all\" />",
			"link:print": "<link rel=\"stylesheet\" href=\"${0:print}.css\" media=\"print\" />",
			"link:favicon": "<link rel=\"shortcut icon\" type=\"image/x-icon\" href=\"${0:favicon.ico}\" />",
			"link:touch": "<link rel=\"apple-touch-icon\" href=\"${0:favicon.png}\" />",
			"link:rss": "<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS\" href=\"${0:rss.xml}\" />",
			"link:atom": "<link rel=\"alternate\" type=\"application/atom+xml\" title=\"Atom\" href=\"${0:atom.xml}\" />",
			"meta:utf": "<meta http-equiv=\"Content-Type\" content=\"text/html;charset=UTF-8\" />",
			"meta:win": "<meta http-equiv=\"Content-Type\" content=\"text/html;charset=windows-1251\" />",
			"meta:compat": "<meta http-equiv=\"X-UA-Compatible\" content=\"${0:IE=7}\" />",
			"style": "<style>",
			"script": "<script>",
			...
			"textarea": "<textarea name=\"\" id=\"\" cols=\"${0:30}\" rows=\"${1:10}\">",
