...
TAB_HANDLER_SCOPES = "source.css, source.sass, source.less, source.scss, source.stylus, source.postcss, source.jade, text.jade, source.pug, text.pug, text.slim, text.xml, text.html - source, text.haml, text.scala.html, source string"

keymap = {
	"expand_abbreviation": "ctrl+e",
	"balance_outward": {"mac": "ctrl+d", "pc": "ctrl+,"},
	"balance_inward": {"mac": "ctrl+j", "pc": "ctrl+shift+0"},
...
standalone_actions = ["wrap_as_you_type", "expand_as_you_type", "rename_tag", "update_as_you_type"]
